...
import { signin, authenticate } from './helper/AuthApiCalls'
...
function Login() {
    ...
    const performRedirect = () => {
        return redirect && <Redirect to="/admin" />;
    };
    ...
    const loginForm = () => {
        return (
            ...
            >
                ...
                { error && <h1 className="text-red-600 bg-red-200 p-2 ">Incorrect Email or Password</h1>}
                <input
